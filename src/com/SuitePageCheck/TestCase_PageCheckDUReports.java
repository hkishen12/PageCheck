...
public class TestCase_PageCheckDUReports extends TestSuiteBase {
	...
	public void checkTestSkip() throws Exception
	 {	 
		TestUtil.checkTestSkip("PageCheckSuite","TestCase_PageCheckDUReports");
	 }	 
	
	@Test
	public void PageCheckDUReport() throws Exception
	{	
		...
		PageCheckUtil.clickOnDUReport();
		PageCheckUtil.compareNameDUReport();
	}
